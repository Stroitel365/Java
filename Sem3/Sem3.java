...
public class Sem3 {
    ...
    public static void main(String[] args) {
        ...
        // -> создать массив больше -> скопировать из меньшего в больший -> добавить
        // новое
...
class Task4 {
    ...
    // public static List<List<String>> fillLibrary0(List<List<String>>
    // genresAndBooks) {
...
class Task2 {
    ...
    // int index = uniquePlanets.indexOf(planet); // Находим индекс планеты в
    // уникальных планетах
...
class Task1 {
    ...
    public static void extracted2() {
        ...
        // Заполняем список десятью случайными числами от 1 до 100
        for (int i = 0; i < 10; i++) {
            // int randomNum = (int)(Math.random() * 96) + 5; // Генерируем числа от 5 до
            // 100
